...
import (
	...
	"github.com/ChenKS12138/collect-homework-go/cmd"
...
func generateAdmin() (token string, err error) {
	...
	_, commonUserToken, err := service.AdminRegisterAndLogin(Ts.URL+"/api", commonUser.Email, commonUser.Password, commonUser.Name)
	if err != nil {
		return "", err
	}
